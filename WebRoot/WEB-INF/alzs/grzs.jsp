    ...
    <div class="lay_s255_m">
        ...
        <div class="lay_main">
            <div class="breadcrumb">您当前的位置是:
                ...
                高龄老人入院感染致死，医院是否存在过失？</div>
            <div class="aticle">
                <h5>高龄老人入院感染致死，医院是否存在过失？
                </h5>
                <p><B>一、基本情况</B></p>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本例系老年患者；自11月21日入院后，其神志一直处于“嗜睡”或“欠清”的状态（护理记录有明确记载，而病程记录无任何体现）；口唇发绀，血氧饱和度88~96%（正常为90~100%），提示其缺氧存在；护理记录始终记载“有痰无力咳出”；病程记录记载：患者呕吐2次，6PM血氧饱和度（O2Sat）降至80~85%，体温升高，并开始抢救。由此可见，该例患者已具备了吸痰适应证；且不能排除其之后发生了误吸，尤其是11月21日、12月3日2次呕吐。
                </p>
                <p>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在滴注时尚需注意：所有用具须消毒后无菌使用；嘱其抬高头部30~45°；室温在20℃以上时稀释液应置于冰箱，24小时内用完；夜间滴速应减慢；并注意监护。本例患者较长时间使用鼻胃管，是否考虑到上述诸项“注意事项”未见病历中有明确记载，对此，不排除医方存在因告知不充分、监护不力所致患者吸入性肺炎的发生可能。
                </p>
                <p>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（2）根据中华医学会检验医学分会《临床微生物学血培养操作规范》采血指征:患者出现以下一种体征时:发热( ≥38 ℃) ；白细胞增多(计数大于10.0 ×109/ L ),C 反应蛋白升高及呼吸加快,在24 h 内采集2～3 次做血培养(一次静脉采血注入到多个培养瓶中应视为单份血培养) 。若入院前两周内接受抗菌药物治疗的患者,连续3d ,每天采集2 份。
                </p>
                <p>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;克林霉素适用于链球菌属、葡萄球菌属及厌氧菌（包括脆弱拟杆菌、产气荚膜杆菌、放线菌等）；哌拉西林钠/他唑巴坦钠主要对于大肠杆菌和拟杆菌属、金黄色葡萄球菌等有效，二者均不能覆盖CAP常见的致病微生物（常规使用β-内酰胺类联合大环内酯类或单用呼吸喹诺酮[左氧氟沙星、莫西沙星]），且克林霉素（患有严重基础疾病的老年人易发生腹泻或假膜性肠炎等不良反应），使用疗程过长（7天），与其菌群失调及整体治疗效果欠佳之间存在一定因果关系。
                </p>
                <p>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（3）微生物化验报告单显示酵母样真菌85%，当日即27日均未见有治疗方案的调整，其存在延误治疗的过失行为。
                </p>
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;6、医方对于患者酸碱失衡的纠正措施不力
                </p>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;综上所述，**医院对患者的诊疗行为存在医疗过失；该医疗过失行为与患者损害后果（死亡）之间存在一定因果关系；医疗过失参与度建议拟20~40%为宜。
                </p>
                <p>
                    <B>五、论证意见</B>
                </p>
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、该医疗过失行为与患者损害后果（死亡）之间存在一定因果关系；3、医疗过失参与度建议拟20~40%为宜。
                </p>
            </div>
