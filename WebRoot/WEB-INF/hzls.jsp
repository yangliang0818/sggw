...
type=image name=btnSearch> -->
        ...
        <DIV><!--第一屏开始-->
            ...
            <div style="margin-bottom: 100px;">
                <p class="areaFont" align="right"><B>排名不分先后，以律师所在地省市汉语拼音首字母排序</B></p>
                <s:iterator value="#session.Hzls" var="hzlsBean">
                    <div style="margin-bottom: 10px;">
                        <div class="inlineDiv" style="margin-right: 15px;">
                            <img src="${hzlsBean.imageName}" alt="${hzlsBean.name}" width="125" height="130"
                                 border="0">
                        </div>
                        <div>
                    <span class="areaFont">姓名：${hzlsBean.name} <br>
                      所在地区：${hzlsBean.area}<br>
                      执业证号：${hzlsBean.number}<br>
                      联系地址：${hzlsBean.address}<br>
                      联系电话：${hzlsBean.tel}<br>
                      电子邮箱：${hzlsBean.email}<br>
                      个人网站：${hzlsBean.website}</span>
                        </div>
                    </div>
                </s:iterator>
            </div>
