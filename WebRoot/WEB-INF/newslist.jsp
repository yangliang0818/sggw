...
type=image name=btnSearch> -->
            ...
            <!--搜索结束--></DIV>
        <BR><!--头部结束--><!--导航开始-->
        <DIV style="width:972px;height: 65px;margin: 0;padding: 0;">
        ...
        <DIV><!--第一屏开始-->
            ...
            <div style="margin-bottom:250px;margin-top: 30px;">
                <p align="center"
                   class="ngtitle"> 案情进展列表
                </p>
                <s:iterator value="#session.pageBeanList" var="newsBean" status="stat">
                    <div style="border-bottom: 1px dashed;border-bottom-color:#ddd;width: 700px;" class="areaFont">
                    <div style="width: 500px;float: left">
                        <li style="list-style: disc;padding-bottom: 0px;"><A href="newsarea!qryNewsArea.action?index=${newsBean.index}">${newsBean.area}${newsBean.title}</A></li>
                    </div>
                    <div align="right">
                        <A href="newsarea!qryNewsArea.action?id=${newsBean.id}">${newsBean.newsDate}</A>
                    </div>
                    </div>
                </s:iterator>
                <br>
                <p align="right" class="areaFont">页码：${currentpage}/${totalpage} 每页：${numberpage}条
                    <a href="newslist!qryPageNews.action?index=1">首页</a>|
                    <a href="newslist!qryPageNews.action?index=${currentpage-1}">上一页</a> |
                    <a href="newslist!qryPageNews.action?index=${currentpage+1}">下一页</a>|
                    <a href="newslist!qryPageNews.action?index=${totalpage}">尾页</a></p>
            </div>
        </DIV>
