...
type=image name=btnSearch> -->
        ...
        <!--BANNER结束--><!--内容部分开始-->
        <DIV><!--第一屏开始-->
            <div style="width: 202px;padding-right: 40px;float: left;">
                <jsp:include page="leftframe.jsp"></jsp:include>
            </div>
            <div style="margin-bottom: 400px;">
                <DIV class=news_tit align="center"><STRONG class=font_24 style="font-family: '微软雅黑'">&nbsp;${newsBean.title}
                </STRONG><font class="araaFont">-----------${newsBean.newsDate}</font><BR>
                </DIV>
                <BR>
                <BR>

                <p class="areaFont" style="padding-left: 5%">
                    &nbsp;&nbsp;&nbsp;&nbsp;${newsBean.content}
                </p> <BR>
                <BR>
                <BR>
                ...
                <BR>
                <BR>
                <p align="right" class="areaFont">
                    <A href="newsarea!qryNewsArea.action?index=${newsBean.index-1}" disable=true>上一案情进展：${newsBean.ptitle}</A>
                    &nbsp;&nbsp;
                    <A href="newslist.action">返回案情列表</A>
                    &nbsp;&nbsp;
                    <A href="newsarea!qryNewsArea.action?index=${newsBean.index+1}">下一案情进展:${newsBean.ntitle}</A>
                </p>
            </div>
        </DIV>
