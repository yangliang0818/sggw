...
<div class="part02 cols">
    ...
    <div class="companyIntro">
        <p class="intro" style="padding-left: 8px;">
            <img src="../images/logo.jpg" alt="" width="79" style="float: left;margin: 0px;padding: 0px;"/>致力于解决各类事故中的专业性问题，也是国内首个以专业技术服务为特色的事故处理平台。事故问拥有医学、法医学、车辆、力学等领域的专家资源与合作鉴定机构，通过我们，可以咨询事故处理中的各种专业技术问题、委托鉴定机构进行事故鉴定、获得专家证人支持等。事故问还拥有全国各地的专业合作律师，可提供事故处理中的法律服务。
        </p>

        <p class="linkmore" style="font-size: 15px;"><a href="wzjj.html" rel="nofollow" target="_blank" style="color: #ab7c12;">点击进入&gt;&gt;</a></p>
    </div>
</div>
<!-- part03 begin-->
<div class="part03 cols">
    ...
    <div class="key_knowledge" style="height: 231px;">
        ...
        <ul class="txtlist">
            <li><a href="dc.html" rel="nofollow" target="_blank">医疗纠纷处理现状及对策</a><img src="../images/re.gif"></li>
            <li><a href="sh.html" rel="nofollow" target="_blank">医疗损害鉴定</a></li>
            ...
            <li><a href="wq.html" rel="nofollow" target="_blank">医疗纠纷，为何需要专家帮助维权？</a></li>
        </ul>
...
<iframe src="tindexframe!init.action" width="985px;" height="817px;"  scrolling="no" frameborder="0px;"></iframe>
</div>
<!-- footer begin-->
