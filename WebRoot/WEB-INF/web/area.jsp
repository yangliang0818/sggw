...
<body onload="setup()">
    <div class="option">
        <label>所在地区</label>
        <span>
              <select id="s1" name="province" style="width: 100px;">
                  <option>省份</option>
              </select>
        </span>
        <span>
              <select id="s2" name="city" runat="server" style="width: 100px;">
              </select>
        </span>
        <span>
           <select id="s3" name="country" runat="server" style="width: 130px;">
           </select>
        </span>
    </div>
</body>
