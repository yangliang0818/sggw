...
<div data-role="page">
    ...
    <div class="ui-content" style="font-size: 14px; line-height: 1.8">
        <h3 style="color: #ab7c12">
            事故问参加南京"321"领军人才科技项目大赛，并成功入围决赛
        </h3>
        <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            2013年10月，事故问参加南京"321"领军人才科技项目大赛，经过初赛与复赛，最终成功闯入决赛。本次“321”领军人才科技项目大赛。据统计，本次入围决赛的参赛项目约占报名项目总数的4%。
        <p align="center">    <img src="http://www.shiguwen.com/images/xcbd/x-3.png" alt=""  width="340px;" height="340px;"></p>
    </div>
    <!--底部版权信息-->
