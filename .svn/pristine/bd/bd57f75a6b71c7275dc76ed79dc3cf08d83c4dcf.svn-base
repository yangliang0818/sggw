...
<HEAD>
    ...
    <jsp:include page="keyword.jsp?pagename=swdh"></jsp:include>
...
type=image name=btnSearch> -->
        ...
        <DIV><!--第一屏开始-->
            ...
            <div style="margin-bottom: 100px;">
                <p align="center"
                   class="ngtitle"> 交通事故三维动画
                </p>

                <p class="areaFontP">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;俗话说“一图胜千言”，事故三维动画，尤其是交通事故三维动画，在交通事故法律诉讼中具有重要意义。由于三维动画具有强烈的演示功能，因此可以使法官以及其他人员直观理解复杂的事故过程，有助于更加清晰的表达己方观点。在某些诉讼中，可以将三维动画作为辩诉的“利器”。
                </p>

                <p class="areaFontP">
                    下面是交通事故三维动画应用于法律诉讼的一个例子。
                </p>

                <p class="areaFontP" align="center">
                    <img src="images/swdh1_biaozhun.gif" width="322"
                         height="230">
                </p>

                <p class="areaFontP" align="center">
                    原告（摩托车主）越过黄线与卡车尾部相撞，动画
                        展示被告（卡车车主）根本没有时间做出避让反应。
                </p>

                <p class="areaFontP" align="center">
                    <img
                            src="images/swdh2_biaozhun.gif" width="330"
                            height="239">
                </p>

                <p class="areaFont" align="center">
                    原告谎称是被告车辆的尾部越过双黄线与其发生碰撞。
                </p>

                <p class="areaFont" align="center">
                    <img
                            src="images/swdh3_biaozhun.gif" width="465"
                            height="237"></p>

                <p class="areaFont" align="center">
                    动画表明是原告越过双黄线与被告车辆发生碰撞，

                    否则原告的最终位置应该在路的另外一侧。

                </p>
                <jsp:include page="interest.jsp?pagename=swdh"></jsp:include>
            </div>
        </DIV>
