...
<div class="part03 cols">
    <div class="traffic_consult" style="height: 231px;">
    ...
    <div class="bruise_consult" style="height: 231px;">
...
<div class="part05 cols"  style="margin-left: 0px;">
    <div style="width: 232px;float: left;">
        <div class="reception_center" style="height: 267px;margin-bottom: 10px;">
            <div class="key_knowledge" style="border: 0px solid #000000;width: 513px;margin-left: 0px;">
                <h6 class="mb_hd">伤残鉴定背景知识</h6>
                ...
                <ul class="txtlist">
                    <li class="liclass"><a href="scjd/dljtsg.html" rel="nofollow" target="_blank">道路交通事故伤残鉴定程序&nbsp;&nbsp;</a><img src="images/re.gif"></li>
                    <li class="liclass"><a href="scjd/jfsssx.html" rel="nofollow" target="_blank">人身损害赔偿纠纷诉讼时效起算</a></li>
                    <li class="liclass"><a href="scjd/rsshjs.html" rel="nofollow" target="_blank">人身伤害伤残鉴定分析介绍</a></li>
                    <li class="liclass"><a href="scjd/scjdbz.html" rel="nofollow" target="_blank">浅谈人身伤残鉴定标准的统一性  </a></li>
                    <li class="liclass"><a href="scjd/scjdfx.html" rel="nofollow" target="_blank">关于伤残鉴定标准的分析  </a></li>
                    <li class="liclass"><a href="scjd/scjdpc.html" rel="nofollow" target="_blank">人身损害伤残鉴定与赔偿标准之缺陷与完善  </a></li>
                </ul>
                <p class="linkmore" style="font-size: 15px;margin-top: 25px;"><a href="scjd/morescjd.html" title="" rel="nofollow" target="_blank">更多知识&gt;&gt;</a></p>
            </div>
        </div>
        <div class="reception_center" style="height: 267px;">
            <div class="key_knowledge" style="border: 0px solid #000000;width: 513px;margin-left: 0px;">
                <h6 class="mb_hd">伤残鉴定背景知识</h6>
                <img src="images/scdj.jpg" alt="" width="86px;" height="86px;" style="float: left;margin-top:28px;margin-right: 15px;margin-left: 10px;margin-bottom: 40px;">
                <ul class="txtlist">
    ...
    <div class="key_knowledge" style="height: 546px;margin-left: 288px;">
        <h6 class="mb_hd">最新咨询</h6>
        <jsp:include page="newask.jsp"></jsp:include>
    </div>
</div>
<!-- part04 begin-->
</div>
