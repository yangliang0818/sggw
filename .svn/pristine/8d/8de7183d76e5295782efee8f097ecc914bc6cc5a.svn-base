...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
    <TR height=28>
        <TD background=images/admin/images/title_bg1.jpg>当前位置:</TD>
    </TR>
    <TR>
        <TD bgColor=#b1ceef height=1></TD>
    </TR>
    <TR height=20>
        <TD background=images/admin/images/shadow_bg.jpg></TD>
    </TR>
</TABLE>
<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
    <TR height=100>
        <TD align=middle width=100><IMG height=100 src="images/admin/images/admin_p.gif"
                                        width=90></TD>
        <TD width=60>&nbsp;</TD>
        <TD>
...
<TABLE cellSpacing=0 cellPadding=0 width="95%" align=center border=0>
    ...
    <TR height=22>
        <TD style="PADDING-LEFT: 20px; FONT-WEIGHT: bold; COLOR: #ffffff"
            align=middle background=images/admin/images/title_bg2.jpg>您的相关信息
        </TD>
    </TR>
