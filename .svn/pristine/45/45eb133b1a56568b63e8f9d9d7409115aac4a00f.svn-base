...
<head>
    ...
    <meta name="description" content="司法鉴定制度是我国司法制度的重要组成部分。司法鉴定结论对案件的处理结果起着至关重要的作用，特别是在人身损害赔偿案件中，司法鉴定结论对案件的定性、赔偿数额的多少起着决定性的作用。但是根据目前人身损害案件的处理情况来看，司法鉴定的形势却不容乐观。我国相关法律只对司法鉴定人员的资格认定以及司法鉴定机构的准入作了相应的规定，而对监督管理制度没有作出具体细致的要求，致使鉴定秩序比较混乱。" />
    ...
    <div class="lay_s255_m">
        ...
        <div class="lay_main">
            ...
            <div class="aticle">
                ...
                <p >
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;一、人身<B><a href="http://www.shiguwen.com">伤残鉴定</a></B>标准的现状
                </p>
                ...
                <p>
                    <jsp:include page="../author.jsp?pageUrl=http://www.shiguwen.com/s-7.html&keywords=伤残鉴定，伤残鉴定标准"></jsp:include>
                </p>
            </div>
