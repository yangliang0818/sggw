...
<div data-role="page">
    ...
    <div class="ui-content" style="font-size: 14px; line-height: 1.8">
        <h3 style="color: #ab7c12">为专家辅助人出庭制度叫好</h3>
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(本内容来源：<a href="http://jxwafy.chinacourt.org/public/detail.php?id=760" style="color: #1a74ba;" target="_blank">万安县法院网</a>  作者：万安县人民法院 郭明生)</p>
