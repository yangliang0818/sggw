...
<HEAD>
    ...
    <jsp:include page="keyword.jsp?pagename=yxzlpg"></jsp:include>
...
type=image name=btnSearch> -->
        ...
        <DIV><!--第一屏开始-->
            ...
            <div style="margin-bottom: 500px;">
                <p align="center"
                   class="ngtitle">医学资料评估
                </p>

                <p class="areaFont">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;相关医学资料包括伤残等级鉴定报告、医院提供的各种医疗资料（病例、诊断证明、CT、X片等）、保险公司从医学角度提出的赔付依据、医院从医学角度提出的赔付依据、对方当事人从医学角度提出的赔付依据，等等。在造成人身伤害的事故中，这些资料对于当事人的经济利益有至关重要的影响，必须确保其准确、客观。
                </p>

                <p class="areaFont">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果您对这些医学资料的准确性无法把握，事故问在法医学/临床医学领域的人才可为您提供医学资料的评估服务与后续帮助，以最大程度的维护您的合法权益。
                </p>
                <jsp:include page="interest.jsp?pagename=yxzlpg"></jsp:include>
            </div>
        </DIV>
