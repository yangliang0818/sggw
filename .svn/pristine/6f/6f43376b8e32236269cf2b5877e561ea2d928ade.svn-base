...
<head>
    ...
    <script type="text/javascript">
        function deleteCase(id) {
            document.forms[0].action = "admindeleteCase!deleteCase.action?id=" + id;
...
<form action="" method="post">
    ...
    <table border="1" width="100%">
        ...
        <s:iterator value="#session.adminNewsBeans" var="newsBean" status="stat">
            <tr>
                <td width="5%" align="center">
                    <input type="button" value="删除"
                           onclick="deleteCase(${newsBean.id})">
                </td>
